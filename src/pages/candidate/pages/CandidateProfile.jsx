    ...
    useEffect(() => {
        ...
        const loadProfile = async () => {
            try {
                ...
                setCvName(profile?.cvName || user.cvName || "");
            } catch (err) {
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex flex-col gap-4">
                                    <div
                                        className={`group relative border-2 border-dashed rounded-2xl p-8 text-center transition-all duration-300 ${cvFile ? 'border-accent-purple bg-accent-purple/5' : 'border-white/10 hover:border-white/30 hover:bg-white/5'
                                            }`}
                                        ...
                                        <div className="flex items-center justify-between p-4 bg-white/5 border border-white/10 rounded-xl">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="text-left">
                                                    <p className="text-sm font-bold text-white truncate max-w-[200px]">{cvName || 'resume.pdf'}</p>
